...
from .views import verify_email, UserRegistrationView, UserLoginView, UserInfoView, UserUpdateView, UserDeleteView, UserUpdateProfileView, RequestPasswordResetView, PasswordResetConfirmView
